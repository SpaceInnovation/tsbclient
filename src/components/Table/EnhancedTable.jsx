              ...
              .map((row, index) => {
                ...
                return (
                  <TableRow hover key={row._id}>
                    ...
                    {properties.map((property) => {
                      ...
                      return (
                        <TableCell
                          ...
                          key={`${row._id}.${property.name}`}
                          component={property.component === true ? "th" : "td"}
                          padding={
                            property.padding === true ? "none" : "default"
                          }
                          numeric={"false"}
                        >
                          {tableCellContent}
                    ...
                    <TableCell className={classes.tableCellPadding}>
                      {addClass ? addClass(row) : null}
                    </TableCell>
                    <TableCell className={classes.tableCellPadding}>
                      {imagePanelDisplay ? imagePanelDisplay(row) : null}
                    </TableCell>
                    <TableCell className={classes.tableCellPadding}>
                      {viewItem ? viewItem(row) : null}
                    </TableCell>
                    <TableCell className={classes.tableCellPadding}>
                      {viewClasses ? viewClasses(row) : null}
                    </TableCell>
                    <TableCell className={classes.tableCellPadding}>
                      {viewTeachers ? viewTeachers(row) : null}
                    </TableCell>
                    <TableCell className={classes.tableCellPadding}>
                      {viewSubjects ? viewSubjects(row) : null}
                    </TableCell>
                    <TableCell className={classes.tableCellPadding}>
                      {viewAllocations ? viewAllocations(row) : null}
                    </TableCell>
                  </TableRow>
                );
              })}
